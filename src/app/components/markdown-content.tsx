      ...
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => {
            ...
            return (
              <h1 className="font-['IBM_Plex_Mono'] text-3xl mt-8 mb-4">
                {children}
              </h1>
            );
          },
          h2: ({ children }) => (
            <h2 className="font-['IBM_Plex_Mono'] text-2xl mt-6 mb-3">
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 className="font-['IBM_Plex_Mono'] text-xl mt-4 mb-2">
              {children}
            </h3>
          ),
          p: ({ children }) => (
          ...
          blockquote: ({ children }) => (
            <blockquote className="italic text-[var(--muted)] my-4">
              {children}
            </blockquote>
          ),
          table: ({ children }) => (
          ...
          thead: ({ children }) => (
            <thead className="bg-[var(--inline-code-bg)]">{children}</thead>
          ),
          tr: ({ children }) => (
